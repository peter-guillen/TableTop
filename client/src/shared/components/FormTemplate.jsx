...
export function QuickSpellModal({ isOpen, onClose }) {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-slate-900 dark:bg-slate-950 rounded-2xl border border-cyan-500/30 dark:border-orange-500/30 shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Modal Header */}
        <div className="sticky top-0 bg-slate-900 dark:bg-slate-950 border-b border-cyan-500/20 dark:border-orange-500/20 p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <LuZap className="text-cyan-400 dark:text-orange-400" size={24} />
            <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-orange-500 dark:from-cyan-300 dark:to-orange-400">
              Quick Add Spell
            </h2>
          </div>
          <button
            onClick={onClose}
            className="text-slate-400 hover:text-white transition-all p-2 hover:bg-slate-800/50 dark:hover:bg-slate-900/50 rounded-lg"
          >
            <LuX size={20} />
          </button>
        </div>
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                rows="4"
                placeholder="Brief spell description..."
                className="w-full px-4 py-3 bg-slate-800/50 dark:bg-slate-900/50 border border-cyan-500/30 dark:border-orange-500/30 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 dark:focus:ring-orange-500 focus:border-transparent transition-all resize-none"
              />
            </div>
          </div>
        ...
        {/* Modal Footer */}
        <div className="border-t border-cyan-500/20 dark:border-orange-500/20 p-6 flex justify-end gap-3">
          <button
            onClick={onClose}
            className="px-6 py-3 rounded-lg font-medium text-slate-400 hover:text-white hover:bg-slate-800/50 dark:hover:bg-slate-900/50 transition-all duration-300"
          >
            Cancel
          </button>
          <button className="px-8 py-3 rounded-lg font-medium bg-gradient-to-r from-cyan-600 to-orange-600 dark:from-cyan-500 dark:to-orange-500 text-white shadow-lg shadow-cyan-500/50 dark:shadow-orange-500/50 hover:shadow-xl hover:shadow-cyan-500/60 dark:hover:shadow-orange-500/60 transition-all duration-300">
...
// Demo Component showing both
export default function SpellCreatorDemo() {
    ...
    <div>
      ...
      <div className="fixed top-4 right-4 z-50 flex gap-2">
        <button
          ...
          className="px-4 py-2 bg-cyan-600 dark:bg-orange-600 text-white rounded-lg shadow-lg hover:bg-cyan-700 dark:hover:bg-orange-700 transition-all"
        >
          {showPage ? "Hide" : "Show"} Full Page
        </button>
        <button
      ...
      {showPage && <SpellCreatorPage />}
      <QuickSpellModal isOpen={showModal} onClose={() => setShowModal(false)} />
    </div>
  );
}
