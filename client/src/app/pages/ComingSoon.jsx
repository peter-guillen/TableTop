      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            <div className="absolute inset-0 bg-cyan-500 dark:bg-orange-500 blur-3xl opacity-30"></div>
        ...
        <div className="mb-6">
          ...
          <p className="text-xl text-slate-400 dark:text-slate-500">
            You've wandered the edge of the boundary, adventurer.
          </p>
        </div>
        ...
        <div className="bg-slate-900/70 dark:bg-slate-950/70 backdrop-blur-md rounded-2xl border border-cyan-500/30 dark:border-orange-500/30 shadow-2xl p-8 mb-8">
          <p className="text-slate-300 leading-relaxed mb-4">
            You come across open fields as far as the eye can see, no mountains,
            no trees, and no life. Just a barren desolate land save for the
            building blocks of something you can't quite define.
          </p>
          <div className="flex items-center justify-center gap-2 text-cyan-400 dark:text-orange-400">
            <LuMapPin size={20} />
            <span className="font-semibold">Location: Boundary's Edge</span>
          </div>
        </div>
