      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-6">
          ...
          <p className="text-xl text-slate-400 dark:text-slate-500">
            You've wandered into uncharted territory, adventurer.
          </p>
        </div>
        ...
        <div className="bg-slate-900/70 dark:bg-slate-950/70 backdrop-blur-md rounded-2xl border border-cyan-500/30 dark:border-orange-500/30 shadow-2xl p-8 mb-8">
          <p className="text-slate-300 leading-relaxed mb-4">
            The path you seek has been consumed by the darkness. Perhaps it
            never existed, or maybe it was destroyed by a rogue dragon. Either
            way, this location is lost to the void.
          </p>
          <div className="flex items-center justify-center gap-2 text-cyan-400 dark:text-orange-400">
            <LuMapPin size={20} />
            <span className="font-semibold">
              Location: The Abyss of Missing Pages
            </span>
          </div>
        </div>
