import { DiceRoll } from "../spellTypes";
import { LuFlame, LuPlus, LuTrash2 } from "react-icons/lu";

interface SpellCombatSectionProps {
  damage: DiceRoll[];
  healing: DiceRoll[];
  onDamageChange: (newData: any) => void;
  onHealingChange: (newData: any) => void;
}
...
export const SpellCombatSection = ({
  ...
  const removeHealing = (index: number) => {
