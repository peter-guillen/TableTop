...
export const SpellPreview = ({ spells }: SpellPreviewProps) => {
  type StyleContext = "border" | "badge" | "hover" | "bg" | "";
  const getItemIcon = (category: SpellSchool) => {
    const iconMap = {
  ...
  function getColorScheme(
    ...
    context: StyleContext = "border",
    extra = "",
  ) {
    const color = spellBaseColors[category] || "gray";
    const template = context ? spellStyleContexts[context] : "";
